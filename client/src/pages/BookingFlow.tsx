          ...
          <CardContent className="p-0">
            <div className="flex items-stretch">
              <div className="w-28 h-28 shrink-0 bg-muted">
                <img src={`/api/img-proxy?url=${encodeURIComponent(prop.photos?.[0] || "https://files.manuscdn.com/user_upload_by_module/session_file/310519663340926600/WYIAhwahEMjJJckK.jpg")}`} alt="" className="w-full h-full object-cover" />
              </div>
