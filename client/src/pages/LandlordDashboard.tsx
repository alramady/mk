                  ...
                  <Card key={p.id} className="card-hover transition-shadow">
                    <CardContent className="p-4 flex items-center gap-4">
                      <div className="w-20 h-20 rounded-lg overflow-hidden shrink-0 bg-muted">
                        <img src={`/api/img-proxy?url=${encodeURIComponent(p.photos?.[0] || "https://files.manuscdn.com/user_upload_by_module/session_file/310519663340926600/WYIAhwahEMjJJckK.jpg")}`} alt="" className="w-full h-full object-cover" />
                      </div>
